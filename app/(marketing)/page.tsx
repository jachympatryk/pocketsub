    ...
    <>
      <section className="mx-auto max-w-7xl">
        ...
        <h3 className="mx-auto max-w-3xl text-center text-xl font-medium text-zinc-700">
          Keep all your payments organized and easily accessible with PocketSub&apos;s simple and convenient tracking
          system, designed to help you stay on top of your finances.
        </h3>
        <Link
          href={"/sign-up/"}
      ...
      <section className="mx-auto max-w-7xl">
        ...
        <h3 className="mx-auto max-w-2xl text-center text-zinc-700">
          Instead of relying on manual methods such as spreadsheets or individual subscription accounts, Pocketsub
          provides a streamlined and user-friendly platform that enables users to easily track and manage all their
          recurring payments and subscriptions in one place.
        </h3>
      </section>
    </>
  );
